...
use Illuminate\Support\Facades\Cache;
    ...
    function heroById($id){
        $hero = collect(heroesData()->heroes)->first(function($hero) use($id){
            // dd($hero);
            return $hero->id == $id;
        });
        if(is_null($hero)){
